...
void countApplesAndOranges(int s, int t, int a, int b, vector<int> apples, vector<int> oranges) {
    ...
    auto apple_it = apples.begin();
    auto orange_it = oranges.begin();

    while (apple_it != apples.end() || orange_it != oranges.end()) {
        if (apple_it != apples.end()) {
            auto position = a + *apple_it;
            if (position <= t && position >= s)
                apple_count++;
            apple_it++;
        }

        if (orange_it != oranges.end()) {
            auto position = b + *orange_it;
            if (position <= t && position >= s)
                orange_count++;
            orange_it++;
        }
